...
OFFSETS_ENTRY("4.19.157-perf+",
  ...
  STRUCT_OFFSETS_4_19,
  .off_init_task=0x0279C9C0,
  .off_init_cred=0x027ACAA8,
  .off_init_uts_ns=0x0279C768,
  .off_empty_zero_page=0x30EB000,
  .off_root_task_group=0x02B09E40,
  .off_selinux_enforcing=0x0345C000,  /* selinux_state */
  .off_kptr_restrict=0x0279C298,
  .off_selinux_blob_sizes=0,
  .off_security_hook_heads=0x022EFF20,
  .off_kmalloc_caches=0x022EFA20,
  .off_anon_pipe_buf_ops=0x01AED800,
  .off_ashmem_misc_fops=0x029C83A0,
  .off_ashmem_fops=0,
  .off_ashmem_ioctl=0,
  ...
  .off_noop_llseek=0x0025F268,
  .off_cap_capable_active=0,
  .off_slide_nfulnl_logger=0x02792690,
  .off_slide_loggers_0_1=0x027925C8,
  .off_slide_boot_id=0x02D4E80C,
