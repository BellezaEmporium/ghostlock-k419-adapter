...
#define INIT_CRED_OFF          0x282CAA8ULL  /* resolved via kallsyms_lookup_name */
#define INIT_UTS_NS_OFF        0x2E1FFC8ULL
#define EMPTY_ZERO_PAGE_OFF    0x30EB000ULL
#define ROOT_TASK_GROUP_OFF    0x30F21C0ULL
#define SELINUX_ENFORCING_OFF  0x34DC000ULL  /* selinux_state */
...
#define ASHMEM_MISC_FOPS_OFF       0x2A483A0ULL
